...
本报告基于代码、配置、迁移、测试和提交历史的实测，**与历史文档（~~project-analysis.md~~（已归档）、[claywords-final-report.md](13-最终交付报告.md)、[next-steps-2026-06-23.md](02-推进路线-2026-06-23.md)）的差异以本报告为准**。
...
| **派单失败路径无埋点** | dispatch_total{outcome=cas_failed/no_capacity} 缺失 → SLI 不全 | [next-steps-2026-06-23.md](02-推进路线-2026-06-23.md) P0-1 |
| **支付验签失败无埋点** | 风控盲区 | 同上 |
...
| 4 | **工艺匹配仍是 substring** | `services/dispatch/scoring.py` | 3-4 天，需 LLM embedding | P1（参见 [craft-vector-similarity.md](15-工艺向量相似度方案.md)） |
...
## 十三、4 周推进路线（基于 [next-steps-2026-06-23.md](02-推进路线-2026-06-23.md) 微调）
...
- **P1-1** 工艺匹配向量化（[craft-vector-similarity.md](15-工艺向量相似度方案.md)，3-4 天）
...
- [next-steps-2026-06-23.md](02-推进路线-2026-06-23.md) — 上一版推进路线
- [code-review-2026-06-22.md](12-代码审查报告-2026-06-22.md) — 代码审查
- [claywords-final-report.md](13-最终交付报告.md) — 06-22 阶段总结
- [security-owasp-top10.md](31-安全自检-OWASP-Top10.md)
- [production-deploy-checklist.md](21-生产部署检查清单.md)
- [craft-vector-similarity.md](15-工艺向量相似度方案.md)
- [hunyuan3d-deployment-guide.md](17-混元3D部署指南.md)
- [business-metrics-dashboard.md](24-业务监控仪表盘.md)
- [slo-definition.md](25-服务等级目标.md)
